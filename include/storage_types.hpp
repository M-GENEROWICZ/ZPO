...
public:
    ...
    PackageQueue(PackageQueueType type) : package_queue_type_(type), package_list_() {};
    ...
    const_iterator begin() const override {return this -> package_list_.cbegin();}
    const_iterator end() const override {return this -> package_list_.cend();}
    const_iterator cbegin() const override {return this -> package_list_.cbegin();}
    const_iterator cend() const override {return this -> package_list_.cend();}
